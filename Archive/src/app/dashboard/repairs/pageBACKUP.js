  ...
  return (
    <div className="container mx-auto max-w-[1400px]">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="flex items-center gap-2">
                <span className="text-slate-700 whitespace-nowrap">Create Repair Email Template:</span>
                <select 
              ...
              <div className="flex items-center gap-2">
                <span className="text-slate-700 whitespace-nowrap">Completed Repair Email Templates:</span>
                <select 
                  className="border border-slate-200 rounded-md px-3 py-2 text-slate-600 w-[220px]"
      ...
      <EditRepairModal
        ...
        selectedCompletedTemplate={selectedCompletedTemplate}
      />
    </div>
  );
}